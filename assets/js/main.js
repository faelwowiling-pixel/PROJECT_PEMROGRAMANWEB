...
(function () {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      const res = await fetch("https://script.google.com/macros/s/AKfycbwJKGmUoSwXZwU6UCgY12vGr4O16U62MDZMHyVi37oBY3mMwHSmG_8NO2IPp0SR5ZAiLw/exec", {
        method: "POST",
      ...
      alert("Pengiriman gagal. Periksa koneksi dan coba lagi.");
      console.error(err);
    }
  });
})();
